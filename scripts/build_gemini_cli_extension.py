...
def main() -> int:
    ...
    _copy_file(ROOT / "scripts" / "bootstrap_windows_python_uv.ps1", DIST / "scripts" / "bootstrap_windows_python_uv.ps1")
    _copy_file(ROOT / "scripts" / "bootstrap_windows_python_uv.cmd", DIST / "scripts" / "bootstrap_windows_python_uv.cmd")
